...
{ 
    ...
    do   
        ...
        echo "Would you like to download or edit a file in the repository?"
        echo "d/e"
        ...
        case "$ans" in
            "e")
                ...
                nano /Projects/"$SelectedRepo"/$fileRef
            ...
            "d")
                ...
                echo "Would you like to download a full repository or a single file from the repository?"
                echo "f/s"
                ...
                case "$fors" in
                    "f")
                        ...
                        echo "Here is a list of all the files currently in the repository:"

                        viewFiles

                        #go to the file to be zipped
                        cd Projects/"$SelectedRepo"

                        zip -r ~/Downloads/test.zip ./*
...
do
    ...
    case "$answer" in 
        ...
        do
            ...
            echo "6) Comple a file in repository"
            echo "7) Roll back a repository"
